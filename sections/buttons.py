...
class handletextpad_adjustment_section(QWidget):
    def __init__(self, selected_graph):
        ...
        #Create a layout for the ncol adjustment section and add the line edit object to it
        columnspacing_section_layout = QVBoxLayout(self.handletextpad_adjustment_section)
        columnspacing_section_layout.addWidget(self.handletextpad_input)
        columnspacing_section_layout.addWidget(self.valid_input_widget)
        columnspacing_section_layout.addWidget(self.invalid_input_widget)
...
class legend_button(QDialog):
    def __init__(self,selected_graph):
        ...
        self.layout.addSpacing(10)
        self.layout.addWidget(handletextpad_adjustment_section(self.selected_graph),stretch=1)
